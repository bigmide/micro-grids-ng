...
export function Stats({ title, value, className }: StatsProps) {
  ...
  return (
    <div
      className={clsx('flex-1 overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-700/40', className)}
    >
      <dl className="flex flex-col items-center p-6">
        ...
        >
          <span ref={elementRef as React.RefObject<HTMLSpanElement>} aria-hidden="true">
            {displayValue}
          </span>
        </dd>
      </dl>
