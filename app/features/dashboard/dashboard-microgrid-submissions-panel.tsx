...
export function DashboardMicrogridSubmissionsPanel({
  microgrids,
}: {
      ...
      <Table striped className="mt-8">
        ...
        <TableBody>
          {microgrids.map((microgrid) => (
            <TableRow
              key={microgrid.id}
              href={`${microgrid.microgridName.toLowerCase().split(' ').join('-')}`}
            >
              <TableCell>
              ...
              <TableCell>
                ...
                <div className="text-zinc-500">
                  {microgrid.geopoliticalZone}
                </div>
              </TableCell>

              <TableCell className="text-zinc-500">
                {formatApiDate(microgrid.createdAt || '')}
              </TableCell>
