  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-12 text-center">
        <h1 className="mb-3 text-3xl font-bold text-gray-800 md:text-4xl">Solar Suppliers & Distributors in Nigeria</h1>
        <p className="mx-auto max-w-3xl text-lg text-gray-600">
          Find reliable solar equipment suppliers and distributors across Nigeria. Connect with providers for your solar
          projects and energy needs.
        </p>
      </div>
      ...
      {/* Registration Form */}
      {showForm && <SupplierRegistrationForm onClose={() => setShowForm(false)} />}
      ...
      <div className="mb-16">
        <h2 className="mb-6 text-2xl font-bold text-gray-800">
          Verified Solar Suppliers {filteredSuppliers.length > 0 && `(${filteredSuppliers.length})`}
        </h2>
      ...
      <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 md:p-8">
        <h2 className="mb-6 text-center text-2xl font-bold text-gray-800">How to Get Listed</h2>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="p-5 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-800">Submit Your Details</h3>
            <p className="text-gray-600">Fill out our registration form with your company information and services.</p>
          </div>
          ...
          <div className="p-5 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-800">Verification Process</h3>
            <p className="text-gray-600">Our team will review your application to ensure quality standards.</p>
          </div>
          ...
          <div className="p-5 text-center">
            ...
            <h3 className="mb-2 text-lg font-semibold text-gray-800">Get Listed</h3>
            <p className="text-gray-600">Once approved, your company will be visible to thousands of customers.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-md transition-shadow hover:shadow-lg">
      <div className="p-6">
        ...
        <div className="mt-5">
          <h4 className="mb-2 font-medium text-gray-800">Products & Services</h4>
          <div className="flex flex-wrap gap-2">
            {['Solar Panels', 'Batteries', 'Inverters', 'Installation'].map((service, idx) => (
              <span key={idx} className="rounded-full bg-teal-50 px-3 py-1 text-xs font-medium text-teal-700">
                {service}
              </span>
            ))}
          </div>
...
function SupplierRegistrationForm({ onClose }: { onClose: () => void }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.products.trim()) newErrors.products = 'Products/services are required'
    ...
    <div className="mb-10 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg">
      <div className="bg-gradient-to-r from-teal-600 to-teal-700 p-5">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold text-white">Supplier Registration Form</h2>
      ...
      {submitSuccess ? (
        <div className="p-8 text-center">
          ...
          <h3 className="mb-2 text-xl font-bold text-gray-800">Registration Successful!</h3>
          <p className="mb-6 text-gray-600">
            Thank you for registering as a solar supplier. Our team will review your application and contact you
            shortly.
          </p>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <label className="mb-1 block text-sm font-medium text-gray-700">Coverage Area (States)</label>
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
                {['Lagos', 'Abuja', 'Kano', 'Rivers', 'Oyo', 'Delta', 'Enugu', 'Others'].map((state) => (
